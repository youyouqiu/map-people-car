...
export const sensorBasicParam = [{
  ...
  //   name: '滤波系数',
  //   key: 'filteringFactor',
  //   component: <Select bordered={false} getPopupContainer={() => getSelectContainer('oilParam')}>
...
// 标定数据(加油数据)
export const addOilData = [{
  name: '加油前',
  key: 'beforeHeight',
  inputProps: {
    disabled: true,
    placeholder: '加油前液体高度(mm)',
  },
  validate: {
    rules: [{
      required: true,
      message: '请在图表中选择加油前的数据',
    }]
  }
},
{
...
},
{
  ...
  inputProps: {
    disabled: true,
    placeholder: '加油后液体高度(mm)',
  },
  validate: {
    rules: [{
      required: true,
      message: '请在图表中选择加油后的数据',
    }]
  }
},
{
