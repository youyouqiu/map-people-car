...
const { Option } = Select;
const { TabPane } = Tabs;
import OilParam from './oilParam';// 油量参数
...
const OilSensor = (props: IProps) => {
  ...
  const referenceObject = [{
    ...
    component: <div>
      <Select
        ...
        getPopupContainer={() => getSelectContainer('oilContainer')}
      >
        {
  ...
  return (
    ...
    >
      <div>
        <div id="oilContainer">
          <TableForm dataSource={referenceObject} column={2} header='参数设置[油量传感器]' />
        </div>
        <div className={styles.innerBox} style={{ paddingBottom: 5 }}>
          <Tabs tabBarStyle={{ marginLeft: 120 }}>
            <TabPane tab="主油箱" key="1">
              <Tabs tabPosition='left'>
                <TabPane tab="油箱参数" key="1">
                  <OilParam
                    sensorOutId={65}
