...
import { getWorkDetailList, exportMachineWorkDetail, WorkDetailList } from '@/server/statistics'
...
const columns: any[] = [
  ...
  },
  {
    title: '路径进度',
    width: 120,
    dataIndex: 'roadFinishRate',
    key: 'roadFinishRate',
    render: (value: number, record: any) => {
      if (record.workType != 1) return '--'
...
const DetailDrawer: React.FC<IProps> = (props) => {
  ...
  const exportData = async () => {
    ...
    const res = await exportMachineWorkDetail({
