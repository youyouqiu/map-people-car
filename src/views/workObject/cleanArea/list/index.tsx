 ...
 * 当前页面权限
 */
const permission = getCurrentUserPermission('4_clearance_area_list');
...
interface IState {
  ...
  enterpriseName: string; //当前选中节点name
...
class WorkPath extends Component<Iprops, IState> {
  ...
  render() {
    const { addVisible, type, selectedRowKeys, queryArgs, detailVisible, initOrgId, rootId, rowId, refreshCount, enterpriseName } = this.state;
